...
@Component({
  ...
  templateUrl: './current-movies-carousel.html',
  styleUrls: ['./current-movies-carousel.css'],
...
export class CurrentMoviesCarousel implements OnInit, OnDestroy, AfterViewInit {
